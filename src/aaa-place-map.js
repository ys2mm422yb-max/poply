...
const mapIcon='<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="m3.5 5.5 5-2.2 7 2.4 5-2.2v15l-5 2.2-7-2.4-5 2.2Z"/><path d="M8.5 3.3v15M15.5 5.7v15"/></svg>';
