...
test('Place Screen V4 remains loaded under the current layout-stability shell release',async()=>{
  ...
  assert.match(index,/aaa-main\.js\?v=20260818-layout1/);
  assert.match(index,/data-build="aaa-foundation-20260818-layout1"/);
});
