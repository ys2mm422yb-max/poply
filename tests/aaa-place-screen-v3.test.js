...
test('Place Screen V4 remains loaded under the current hierarchy shell release',async()=>{
  ...
  assert.match(index,/aaa-ui-hierarchy-active\.css\?v=20260818-hierarchy3/);
  assert.match(index,/aaa-main\.js\?v=20260818-hierarchy3/);
  assert.match(index,/data-build="aaa-foundation-20260818-hierarchy3"/);
});
