...
try{
  ...
  await prepareOrder(targetId);await openOrders();await page.locator(`[data-select-order="${targetId}"]`).click();
  ...
  await prepareOrder(other.id);await openOrders();await page.locator(`[data-select-order="${other.id}"]`).click();await page.locator(`.service-card[data-service-order="${other.id}"] button[data-order="${other.id}"]`).click();
